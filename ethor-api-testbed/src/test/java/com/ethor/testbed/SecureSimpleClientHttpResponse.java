...
public class SecureSimpleClientHttpResponse implements ClientHttpResponse {
	...
	SecureSimpleClientHttpResponse(final HttpURLConnection connection, final SecureSimpleClientHttpRequest request) {
	...
	public void setReplayResponse(final SecureSimpleClientHttpResponse replayResponse) {
